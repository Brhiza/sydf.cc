    ...
    function createCommonLayoutHTML() {
        const html = [
            ...
            '<nav class="sidebar">',
                ...
                '</div>',
                '<ul>',
                    '<li><a href="ly" class="nav-link">六爻</a></li>',
                    '<li><a href="mh" class="nav-link">梅花易数</a></li>',
                    '<li><a href="qm" class="nav-link">奇门遁甲</a></li>',
                    '<li><a href="dp" class="nav-link">塔罗牌·单牌</a></li>',
                    '<li><a href="sp" class="nav-link">塔罗牌·三牌</a></li>',
                    '<li><a href="ssgw" class="nav-link">三山国王灵签</a></li>',
                    '<li><a href="history" class="nav-link">历史记录</a></li>',
                    '<li><a href="rengong" class="nav-link">转人工</a></li>',
