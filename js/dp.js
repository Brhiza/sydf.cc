const imageUrlPrefix = "static/mx/";
const tarotCards = [
    // 大阿卡纳
    { number: 1, name: "愚者" },
    { number: 2, name: "魔术师" },
...
document.getElementById('submitButton').addEventListener('click', async () => {
    ...
    const { number, name, position } = generateRandomCard();
    ...
    outputText.innerHTML = `
        <div class="hexagram-container tarot">
            <div class="hexagram-item tarot">
                <img data-src="${imageUrlPrefix}${number}.jpg" alt="${displayName}" class="lazy-load" />
    ...
    const imgElement = outputText.querySelector('.lazy-load');
    if (imgElement) {
