...
function paipan() {
     ...
     */
    this.czs = ["长生(强)", "沐浴(凶)", "冠带(吉)", "临官(大吉)", "帝旺(大吉)", "衰(弱)", "病(弱)", "死(凶)", "墓(吉)", "绝(凶)", "胎(平)", "养(平)"];
    this.yyss = ['异', '同'];
     ...
     */
    this.queryShenSha = function(pillarGZ, baziArray, isMan, pillarIndex, nianNayin) {
        const shenShaList = [];
