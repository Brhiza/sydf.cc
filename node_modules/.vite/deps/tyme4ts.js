...
var LunarYear = class _LunarYear extends AbstractTyme {
  static isInit = false;
  static LEAP = [];
  year;
  static init() {
...
var LunarMonth = class _LunarMonth extends AbstractTyme {
  static cache = {};
...
var LunarWeek = class _LunarWeek extends AbstractTyme {
...
var LunarDay = class _LunarDay extends AbstractTyme {
  ...
  getNineStar() {
    ...
    const xiaZhiSolar = dongZhi.next(12).getJulianDay().getSolarDay();
    const dongZhiSolar2 = dongZhi.next(24).getJulianDay().getSolarDay();
...
var LunarHour = class _LunarHour extends AbstractTyme {
...
var SolarHalfYear = class _SolarHalfYear extends AbstractTyme {
...
var SolarSeason = class _SolarSeason extends AbstractTyme {
...
var SolarMonth = class _SolarMonth extends AbstractTyme {
...
var SolarWeek = class _SolarWeek extends AbstractTyme {
  static NAMES = ["第一周", "第二周", "第三周", "第四周", "第五周", "第六周"];
  month;
  index;
  start;
...
var SolarDay = class _SolarDay extends AbstractTyme {
  ...
  getPlumRainDay() {
    ...
    let end = grainInEar.next(2).getJulianDay().getSolarDay();
    ...
    if (matcher) {
      ...
      switch (type) {
        ...
        case 1:
          ...
          return new _LunarFestival(1, solarTerm.getJulianDay().getSolarDay().getLunarDay(), solarTerm, data);
        case 2:
...
var China95ChildLimitProvider = class extends AbstractChildLimitProvider {
  getInfo(birthTime, term) {
...
var LunarSect1ChildLimitProvider = class extends AbstractChildLimitProvider {
  getInfo(birthTime, term) {
...
var LunarSect2ChildLimitProvider = class extends AbstractChildLimitProvider {
  getInfo(birthTime, term) {
    let minutes = ~~(Math.abs(term.getJulianDay().getSolarTime().subtract(birthTime)) / 60);
    const year = ~~(minutes / 4320);
    minutes %= 4320;
...
var RabByungMonth = class _RabByungMonth extends AbstractTyme {
  static DAYS = {};
  static NAMES = ["正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"];
...
var RabByungDay = class _RabByungDay extends AbstractTyme {
  static NAMES = ["初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十", "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十", "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八", "廿九", "三十"];
  month;
  day;
  leap;
...
//# sourceMappingURL=tyme4ts.js.map
